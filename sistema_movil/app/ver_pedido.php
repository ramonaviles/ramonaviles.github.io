...
<div class="container">
    <div class="">
        ...
        if($estado_pedido == "ASIGNADO"){ ?>
            <a href="controller_tomar_pedido.php?id_p=<?php echo $id_pedidos_p;?>&&email_m=<?php echo $email_m;?>" class="btn btn-primary btn-block btn-lg">
                <i class="fa fa-motorcycle"></i> Tomar pedido
            </a>
            <?php
        }
        if($estado_pedido == "PEDIDO TOMADO"){ ?>
            <a href="controller_finalizar_pedido.php?id_p=<?php echo $id_pedidos_p;?>&&email_m=<?php echo $email_m;?>"
