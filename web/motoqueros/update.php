                    ...
                    <div class="container">
                        ...
                        <div class="card card-success card-outline">
                            <div class="card-header">
                                <h3 class="card-title"><span class="fa fa-users"></span> Actualización de datos de motoqueros</h3>
                            </div> <!-- /.card-body -->
                            <div class="card-body">
                                <?php
                                ...
                                <form action="controller_update.php" method="post">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="placa" value="<?php echo $placa;?>">
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <input type="submit" class="btn btn-success btn-lg" value="Actualizar Motoquero">
                                </form>
                            </div><!-- /.card-body -->
                        </div>
                    </div>
