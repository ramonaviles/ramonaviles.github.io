                    ...
                    <div class="container">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title"><span class="fa fa-users"></span> Listado de Motoqueros</h3>
                                <div style="float:right;">
                                    <a href="create.php" class="btn btn-info pull-right"> <span class="fa fa-plus"></span> Nuevo motoquero</a>
                                </div>
                            </div> <!-- /.card-body -->
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <table class="table table-bordered table-sm">
                                            ...
                                            <th style="background: #c0c0c0"><b>Placa</b></th>
                                            ...
                                            <?php
                                            $contador = 0;
                                            $query2 = $pdo->prepare("SELECT * FROM tb_usuarios WHERE cargo = 'MOTOQUERO' AND estado ='1'");
                                            $query2->execute();
