        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="container">
                        <br>
                        <center><h3>¿Esta seguro de borrar a este motoquero?</h3></center>
                        <div class="card card-danger card-outline">
                            <div class="card-header">
                                <h3 class="card-title"><span class="fa fa-users"></span> Borrar motoquero</h3>
                            </div> <!-- /.card-body -->
                            <div class="card-body">
                                <?php
                                ...
                                <form action="controller_update.php" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                <label for="">Ci</label>
                                                <input type="text" class="form-control" name="ci" value="<?php echo $ci;?>" disabled>
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <br>
                                    <a href="<?php echo $URL;?>/web/motoqueros" class="btn btn-default btn-lg">Cancelar</a>
                                    <a href="controller_delete.php?email=<?php echo $email;?>" class="btn btn-danger btn-lg">Borrar Motoquero</a>
                                </form>
                            </div><!-- /.card-body -->
                        </div>
                    </div>
